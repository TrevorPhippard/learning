...
import { CommentRepository, COMMENT_REPOSITORY } from '../../domain/ports/comment-repository.port';
...
export class CommentService {
  ...
  async create(dto: CreateCommentDto) {
    const comment = new Comment(CommentId.of(uuidv4()), PostId.of(dto.postId), UserId.of(dto.authorId), dto.content);
